(()=>{
"use strict";
const CRITICAL="/weather/critical.json",FULL="/weather/dashboard-data.json",TIDE="/weather/tide.json";
const AQ=["https://raw.githubusercontent.com/kenzuko/Jotrip-Lab/data-weather/data/weather-aqi/latest.json","/weather/air-quality.json"];
