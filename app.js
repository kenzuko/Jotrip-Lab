...
const extraStyle=document.createElement('style');extraStyle.textContent=`.search-wrap{margin:0 0 12px}.search-wrap input{height:48px;padding-left:42px;background:#f9fcfd;border-color:#d8e6ee}.search-wrap{position:relative}.search-wrap:before{content:'⌕';position:absolute;left:15px;top:9px;font-size:24px;color:#72869a;z-index:1}.status-pill.amber{font-weight:950}.drawer-meta .fr24-detail-row a{color:#166f9f;text-decoration:none;font-weight:900}.drawer-meta .fr24-detail-row a:active{opacity:.68}@media(max-width:680px){.search-wrap input{font-size:16px;height:48px}.status-pill{max-width:150px;overflow:hidden;text-overflow:ellipsis}.drawer-meta .fr24-detail-row a{display:inline-flex;align-items:center;min-height:34px}}`;document.head.appendChild(extraStyle);
