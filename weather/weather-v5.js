...
const URLS={
  ...
  icon:["./spatial-icon.json","/Jotrip-Lab/weather/spatial-icon.json","https://raw.githubusercontent.com/kenzuko/Jotrip-Lab/feat/weather-lab-data-engine-v1/weather/spatial-icon.json"],
